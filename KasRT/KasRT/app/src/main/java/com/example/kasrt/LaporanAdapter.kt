...
class LaporanAdapter(private val data: MutableList<DataItem>) :
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.tvTotalIuranRekap.text = "3. Total Iuran Rekap (Setahun) : " + item.total_rekap_iuran_bulanan.toString()
    ...
    class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var tvIuranPerwarga: TextView = itemView.findViewById(R.id.jumlahIuranPerwargaTextView)
